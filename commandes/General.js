...
zokou({ nomCom: "dev", categorie: "General", reaction: "🚘" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Mickey", numero: "255711765335" },
      { nom: "denzel", numero: "255612130873" },
      { nom: "Mickey team", numero: "255615944741" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "THIS IS OFFICIAL COMMAND FOR CONTACT ALL DEVELOPER ASK ANY QUESTION YOU WANT:\n\n";
